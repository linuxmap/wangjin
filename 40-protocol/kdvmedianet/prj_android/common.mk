...
ifeq ($(LINUX_COMPILER),_HHPPC_82XX_)
  LDFLAGS += --static
endif

ifeq ($(LINUX_COMPILER),_HHPPC_85XX_)
  LDFLAGS += --static
endif
...
ifeq ($(LINUX_COMPILER),_ANDROID_)
CROSS = /opt/android-ndk-r9d/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86_64/bin/arm-linux-androideabi-
endif
